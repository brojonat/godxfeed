            ...
            this._el
              ...
              .tween("progress", function () {
                ...
                return function (progressPercent) {
                  ...
                  return (0, _d3Selection.select)(thisElement).attr(
                    "d",
                    self._getPath(self._percent)
                  );
                };
              });
          },
    ...
    var SimpleGauge = /*#__PURE__*/ (function () {
      ...
      function SimpleGauge(config) {
        ...
        if (
          ...
          throw new RangeError(
            "The chart inset must be greater or equal to 0."
          );
        }
      ...
      _createClass(SimpleGauge, [
        {
          ...
          set: function set(interval) {
            ...
            this._scale = (0, _d3Scale.scaleLinear)()
              .domain(interval)
              .range([0, 1])
              .clamp(true);
          },
          ...
          value: function _initialize() {
            ...
            this._chart = this._el
              ...
              .attr(
                "transform",
                "translate("
                  .concat(this._width / 2, ", ")
                  .concat(this._height, ")")
              );
            this._arcs = this._chart
              .selectAll(".arc")
              .data((0, _d3Array.range)(1, this._sectionsCount + 1))
              .enter()
              .append("path")
              .attr("class", function (sectionIndex) {
              ...
              .attr("d", function (sectionIndex) {
                ...
                var endPadRad =
                  sectionIndex === _this._sectionsCount ? 0 : padRad / 2;
                var arc = (0, _d3Shape.arc)()
                  .outerRadius(radius - _this._chartInset)
                  .innerRadius(radius - _this._chartInset - _this._barWidth)
        ...
        },
        {
          ...
          value: function _update() {
            ...
            this._arcs.classed("active", function (d, i) {
              return (
                i === Math.floor(_this2._percent * _this2._sectionsCount) ||
                (i === _this2._arcs.size() - 1 && _this2._percent === 1)
              );
            });
